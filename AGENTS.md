...
The next step for you is to call `(agent-shell-fanout-worktrees (list (cons "TITLE-OF-TASK" "INITIAL-QUESTION-AND-CONTEXT-FOR-AGENT")) CHOSEN-DIRECTORY-FROM-PREVIOUS-STEP)`.
